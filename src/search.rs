...
Shelved games created: {}", shelved.len());
    ...
    /// Regression test: a known-winnable PySolFC Klondike deal.
    ///
    /// Seed: 13101775566348840960 (from PySolFC Demo Log -> "Play this game")
    ///
    /// This test is marked `ignore` because DFS may take a while depending on
    /// your machine and solver heuristics.
    ///
    /// Run with:
    ///   cargo test --release pysol_seed_13101775566348840960_is_winnable -- --nocapture
    #[test]
    #[ignore]
    fn pysol_seed_13101775566348840960_is_winnable() {
        // Deck in DEALING ORDER (first element = first card dealt), mapped to
        // klondike_chat's Card::index() scheme.
        // Generated by dump_pysolfc_deal.py after matching PySolFC's shuffle.
        let deck: [Card; CARDS_PER_DECK as usize] = [
            Card(51), Card(32), Card(3),  Card(27), Card(35), Card(7),
            Card(45), Card(15), Card(5),  Card(6),  Card(39), Card(31),
            Card(17), Card(21), Card(48), Card(47), Card(41), Card(11),
            Card(46), Card(38), Card(14), Card(40), Card(19), Card(22),
            Card(49), Card(36), Card(1),  Card(29), Card(26), Card(18),
            Card(2),  Card(12), Card(42), Card(8),  Card(10), Card(16),
            Card(0),  Card(44), Card(24), Card(23), Card(30), Card(34),
            Card(20), Card(9),  Card(4),  Card(33), Card(37), Card(28),
            Card(50), Card(25), Card(43), Card(13),
        ];

        let config = SearchConfig {
            // Conservative but finite limits for a long-ish DFS.
            limits: SearchLimits {
        ...
        let out = solve_single_deck_with_config(deck, &config);
        assert!(
            out.is_win,
            "expected deal to be solvable; got is_win=false (nodes={}, max_branch_depth={})",
            out.nodes_visited, out.max_branch_depth
        );
    }
}
